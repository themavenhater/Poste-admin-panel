...
function ArticlesCount() {
  const {documents} = useSelector(({statDocs}) => statDocs.documentsReducer);
  ...
  const totalViews = documents.reduce((acc, cur) => [...acc, ...cur.views], [])
      ...
      <div className="widget flex w-full sm:w-1/2 md:w-1/2 p-12">
        <Paper className="w-full rounded-8 shadow-none border-1">
          <div className="text-center pt-12 pb-28">
            ...
            <Typography className="text-16" color="textSecondary">Total Téléchargement</Typography>
          </div>
        </Paper>
      </div>
      <div className="widget flex w-full sm:w-1/2 md:w-1/2 p-12">
        <Paper className="w-full rounded-8 shadow-none border-1">
          <div className="text-center pt-12 pb-28">
            ...
            <Typography className="text-16" color="textSecondary">N° télécharegement de cette semaine</Typography>
          </div>
        </Paper>
      </div>
...
export default withReducer('statDocs', reducer)(ArticlesCount)
